...
<html lang="en">
  <head>
   ...
   <script src="plugins/angularJS/uang.js"></script>
   <style>
      ...
      <div class="main_container">
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="./" class="site_title"><span> &nbsp;Umar Bin Khotob Plus</span></a>
            </div>
        ...
        <footer>
          <div class="pull-right">
            Copyright © 2018 Umar bim Khotob Plus. All rights reserved. 
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
