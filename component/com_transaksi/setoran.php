            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <form action="?module=transaksi_aksi&act=setoran&id=<?php echo $r[no_rekening];?>"  enctype="multipart/form-data" method="POST" >
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>
                                            <h3><small>Saldo di Kantin : </small>Rp. <?php echo rupiah($saldo_kantin);?></h3>
                                        </label>
                                        <input type="hidden" name="txtSaldoKantin" value="<?php echo $saldo_kantin;?>"><br>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button type="submit" name="tunai" class="btn btn-success btn-sm">Tambah Saldo</button>
                                            <br>
                                        </div>
                                        <br>
                                    </div>
